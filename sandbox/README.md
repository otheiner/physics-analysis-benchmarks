...
To make the comparison of LLM agentic capabilities fair there are only some libraries allowed on top of the standard python libraries. This list is specified in `requirements.txt` in this folder. Since this is new project, new tools and libraries might be added.
